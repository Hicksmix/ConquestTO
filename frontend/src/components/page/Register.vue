...
<template>
  ...
  <h1 class="form-header">PROFIL ERSTELLEN</h1>
  ...
  <button type="submit" :disabled="disableSubmit()" class="button mx-auto my-4"
          :class="{ ['button-loading']: isLoading }">Registrieren</button>
</form>
